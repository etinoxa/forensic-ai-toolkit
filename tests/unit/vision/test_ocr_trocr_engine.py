...
import types
import fait.vision.ocr.engines.trocr_engine as trocr_mod
...
def test_trocr_defaults_and_cache(tmp_paths, monkeypatch):
    ...
    monkeypatch.setenv("HF_HOME", str(tmp_paths.models_cache / "ocr" / "hf"))
    ...
    eng = trocr_mod.TrOCREngine(model_id=None, cache_dir=str(tmp_paths.models_cache / "ocr" / "hf"))
...
def test_trocr_env_model_id(tmp_paths, monkeypatch):
    ...
    eng = trocr_mod.TrOCREngine(cache_dir=str(tmp_paths.models_cache / "ocr" / "hf"))
