# src/fait/audio/embeddings/resnet_embedder.py
...
class ResNetEmbedder(_BaseAudioEmbedder):
    """
    Speaker embeddings from SpeechBrain ResNet34:
    ...
    def __init__(
        ...
        self.cache_root = Path(cache_dir or (paths.models_cache / "audio" / "resnet"))
