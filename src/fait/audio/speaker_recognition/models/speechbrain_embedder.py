# src/fait/audio/speaker_recognition/models/speechbrain_embedder.py
...
class SpeechBrainEmbedder(_BaseAudioEmbedder):
    """ECAPA-TDNN speaker models via SpeechBrain, Windows-safe (no symlinks)."""
    ...
    def __init__(
        ...
        self.cache_dir = cache_dir or str(paths.models_speaker_recognition / "speechbrain")
