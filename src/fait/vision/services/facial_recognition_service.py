# src/fait/vision/services/facial_recognition_service.py
...
log = logging.getLogger("fait.vision.services.facial_recognition_service")
...
class FaceServiceConfig:
    ...
    cache_dir: str = str(get_paths().models_facial_recognition)   # <— changed default
    det_width: int = 640
    det_height: int = 640
